...
import uk.gov.hmrc.nisp.services.reference.EarningLevelService

case class NITaxYear(taxYear: Int, totalEarningsFactorPostMarkup: BigDecimal, classTwoLiabilityCreditShortfall: Int,
                      classOneContributions: BigDecimal, classTwoCredits: Int, classThreeCredits: Int, otherCredits: Int) {
