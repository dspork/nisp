...
object QualifyingYearsAmountService {
  ...
  private lazy val amountMatrix: Map[Int, BigDecimal] = {
    Map(
      0 -> 0, 1 -> 4.45, 2 -> 8.89, 3 -> 13.34, 4 -> 17.79, 5 -> 22.24, 6 -> 26.68, 7 -> 31.13, 8 -> 35.58, 9 -> 40.02, 10 -> 44.47, 11 -> 48.92, 12 -> 53.37, 13 -> 57.81, 14 -> 62.26, 15 -> 66.71, 16 -> 71.15, 17 -> 75.60, 18 -> 80.05, 19 -> 84.50, 20 -> 88.94, 21 -> 93.39, 22 -> 97.84, 23 -> 102.28, 24 -> 106.73, 25 -> 111.18, 26 -> 115.63, 27 -> 120.07, 28 -> 124.52, 29 -> 128.97, 30 -> 133.41, 31 -> 137.86, 32 -> 142.31, 33 -> 146.76, 34 -> 151.20, 35 -> 155.65
    )
  }
